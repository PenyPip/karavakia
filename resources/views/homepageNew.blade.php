...
<body>
    ...
    <!--Memorable cruises-->
    <div style="margin-left:25px; margin-right:25px; text-align:center; align-items:center;">
        <h5 style="text-align:center; color:#0d6efd">Pegasus Cruises</h5>
    ...
    <div class="container">
        <div style="display:grid; grid-template-columns: 1fr 1fr 1fr">
            <div style="margin:20px;">
                <div style="margin-bottom:20px; background:url(images/cropped-for-home-hydra-pegasus-cruise4-370x370.jpg); border-radius:100%; text-align:center; color:#fff; background-position:center; width:270px; height:270px; background-repeat:no-repeat;">
                    <p style="padding-top:50%;"><a href="/hydra" style="color:#fff; font-weight:500;">ΥΔΡΑ</a></br></p>
                </div>
                <div style="background:url(images/cropped-for-home-spetses-pegasus-cruises-370x370.jpg); border-radius:100%; text-align:center; color:#fff; background-position:center; width:270px; height:270px; background-repeat:no-repeat;">
                    <p style="padding-top:50%;"><a href="/spetses" style="color:#fff; font-weight:500;">ΣΠΕΤΣΕΣ</a></p>
                </div>
            </div>
            <div style="margin:20px;">
                <div style="margin-bottom:20px; background:url(images/cropped-for-home-skiathos-page-4-370x370.jpg); border-radius:100%; text-align:center; color:#fff; background-position:center; width:270px; height:270px; background-repeat:no-repeat;">
                    <p style="padding-top:50%;"><a href="/skiathos" style="color:#fff; font-weight:500;">ΣΚΙΑΘΟΣ</a></br></p>
                </div>
                <div style="background:url(images/cropped-for-home-nauplio-370x370.jpg); border-radius:100%; text-align:center; color:#fff; background-position:center; width:270px; height:270px; background-repeat:no-repeat;">
                    <p style="padding-top:50%;"><a href="/skopelos" style="color:#fff; font-weight:500;">ΝΑΥΠΛΙΟ</a></p>
                </div>
            </div>
            <div style="margin:20px;">
                <div style="margin-bottom:20px; background:url(images/cropped-for-home-alonissos-370x370.jpg); border-radius:100%; text-align:center; color:#fff; background-position:center; width:270px; height:270px; background-repeat:no-repeat;">
                    <p style="padding-top:50%;"><a href="/alonissos" style="color:#fff; font-weight:500;">ΑΛΟΝΗΣΣΟΣ</a></br></p>
                </div>
                <div style="background:url(images/cropped-for-home-monemvasia-cruise-pegasus-370x370.jpg); border-radius:100%; text-align:center; color:#fff; background-position:center; width:270px; height:270px; background-repeat:no-repeat;">

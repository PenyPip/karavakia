            ...
            <div class="tour-content" style="margin-top:50px; background-color:#F2F2F2; border-radius:8px; padding:15px; margin-left:100px;">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div>
                                <h2 style="font-size:20px;"><strong>Boarding at the port of Tolo</strong></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div>
                                <h2 style="font-size:20px;"><strong>Departure for Hydra</strong></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div>
                                <h2 style="font-size:20px;"><strong>Arrival in Hydra</strong></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div>
                                <h2 style="font-size:20px;"><strong>Departure from Hydra</strong></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div>
                                <h2 style="font-size:20px;"><strong> Arrival in Spetses</strong></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div>
                                <h2 style="font-size:20px;"><strong>Departure from Spetses</strong></h2>
                                <p>Return to Tolo</p>
                            </div>
                        </div>
                    </div>

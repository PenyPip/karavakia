...
<body>
    ...
    <container>
        ...
        <h3 style="margin-bottom:80px; background:url(/images/hydra_2-1.jpg); background-repeat:no-repeat; width:100%; height:380px; position:relative; font-size:46px; font-weight:100; color:#fff; padding-top:175px; padding-left:61.5px; padding-right:61.5px; top:50%;">More about the island</h3>
        <div class="row">
            <div class="col-8">
